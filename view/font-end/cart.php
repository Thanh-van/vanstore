			...
			<div class="container">
				<div class="row row-pb-lg">
					<div class="col-md-10 offset-md-1">
						<div class="process-wrap">
							...
							<div class="process text-center checkout">
								<p><span>02</span></p>
								<h3>Checkout</h3>
							</div>
							<div class="process text-center order">
								<p><span>03</span></p>
										...
										<div class="row form-group">
											<div class="col-sm-3">
												<?php if(isset($_SESSION['cart'])){
														?>
														<input type="submit" value="next" class="btn btn-primary nex_checkout">
														<?php
												} ?>
				...
				<div class="row">
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?= host . '/' . name_project . view_font; ?>images/item-1.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?= host . '/' . name_project . view_font; ?>images/item-2.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?= host . '/' . name_project . view_font; ?>images/item-3.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
					...
					<div class="col-md-3 col-lg-3 mb-4 text-center">
						<div class="product-entry border">
							<a href="#" class="prod-img">
								<img src="<?= host . '/' . name_project . view_font; ?>images/item-4.jpg" class="img-fluid" alt="Free html5 bootstrap 4 template">
							</a>
							<div class="desc">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></span> 
  ...
  $( document ).ready(function() {
	...
	$('.nex_checkout').on('click',function(e){
		e.preventDefault();
